...
public class AbstractValidator {
    ...
    public static final String ALREADY_COMBINATION = "Exists this combination!";
    public static final String THIS_ARTICLE_IS_NOT_EXISTS = "This article is not exists!";
    public static final String YOU_ARE_NOT_AUTHOR = "You are not author of this article!";
    public static final String NOT_ALLOWED_OPERATION = "The operation you want to perform is not allowed!";
